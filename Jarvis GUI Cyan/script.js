...
var hologram = document.getElementById('body');
...
function handleMouseMove(event) {
  ...
  var rotateY = (x - window.innerWidth / 2) / 10;
  var rotateX = -(y - window.innerHeight / 2) / 10;

  // Apply rotation to hologram
  hologram.style.transform = `rotateY(${rotateY}deg) rotateX(${rotateX}deg) translateZ(50px)`;
}
